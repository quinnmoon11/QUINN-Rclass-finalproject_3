---
title: "Are Critically Imperiled Six-Lined Racerunner Lizards Native or Introduced to Michigan?"
subtitle: "Project 3"
author: "Quinn Moon"
date: "04/30/2023"
...
![Photo of a Six-Lined Racerunner Lizard I took in my yard in New Mexico](Images/sexlin_NM.jpg)
...
![Fig 1. Map highlighting the counties in Indiana and Michigan with recorded populations of six-lined racerunner lizards (Minton 2001). Populations in the Porter, Starke, and LaPorte counties of Indiana are geographically closest to the population in Tuscola County, Michigan. **Figure made entirely in R. See (Analysis_code/Isolatedmapping.R) for script**](../../Results/isolated_counties.jpeg)
...
![Fig 2. Map of the range of six-lined racerunner lizards and the museum samples collected with the corresponding catalog number. **For this figure, the base map with sampling locations was made in R, but the range map, in green, needed to be hand drawn using Inkscape**](Images/allsampling.jpg)
...
::: {layout-ncol=2}
![A. Native](../../Results/intro_phylo_nat.pdf)

![B. Introduced](../../Results/intro_phylo_intro.pdf)
:::
...
![Fig 4. Map showing the final samples included in ddRADseq library. **Map made entirely in R using (Analysis_code/allmapping.R)** ](../../Results/final_samples_used.jpeg)
...
![Fig 5. Phylogenetic tree constructed with all samples using default parameters in the assembly. The clade containing Michigan and Indiana and the general topology by geographic region is highlighted using vertical bars. **Initial .tre file was visualized in Figtree before loading, rooting, and annotating in R using (Analysis_code/G1_phylo.R).**](../../Results/RefG1_annotated.jpeg)
 

![Compare this to the original file I made using fig.tree and inkscape](Images/final_refG1.jpg)
...
![I used these maps from R **(Analysis_code/discuss_figure.R**)](../../Results/discuss_fig_maps.pdf)
![And simple phylos from R to compile and add detail in inkscape **(Analysis_code/discuss_map)**](../../Results/discuss_fig_phylo.pdf)

![Fig. 7 Diagram depicting the predicted settlement pattern and corresponding phylogeny for the two hypothesized origins of the Michigan population- recent anthropogenic introduction (A) or native post-glacial northern dispersal (B).**This is a great example of these lines and legend being very hard to make in R so a tool like Inkscape might be a better idea!**](Images/final_discuss_figure.jpg)
