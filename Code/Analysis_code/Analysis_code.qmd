...
![Fig 2. Map of the range of six-lined racerunner lizards and the museum samples collected with the corresponding catalog number. For this figure, the base map and points was made in R, but the range map, in green, needed to be hand drawn using Inkscape](Images/allsampling.jpg)
...
![Fig 4. Map showing the final samples included in ddRADseq library ](../../Results/final_samples_used.jpeg)
...
![Fig. 7 Diagram depicting the predicted settlement pattern and corresponding phylogeny for the two hypothesized origins of the Michigan population- recent anthropogenic introduction (A) or native post-glacial northern dispersal (B).](Images/final_discuss_figure.jpg)
